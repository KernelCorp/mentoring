Feature: Meetings
  ...
  Scenario: Curator add a new book
    ...
    When I go to "/books"
     ...
     And I fill in an input "name" as "Wikipedia. Premium Edition" in the form "book_new"
     And I select priority "must-read"
  ...
  Scenario: Mentor see books
    Given I signed in as user with email: "bender@example.com"
  ...
  Scenario: Mentor send comment
    ...
    And a book with title: "Wikipedia. Premium Edition", owner: "zoidberg@example.com"
    When I go to "/books"
    And I click on book woth title: "Wikipedia. Premium Edition"
    And I fill in an input "text" as "Awesome!" in the form "new_comment"
    And I click to the submit button
    Then I should a new comment
