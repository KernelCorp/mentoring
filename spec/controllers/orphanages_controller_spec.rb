...
RSpec.describe OrphanagesController, :type => :controller do
  ...
  # Orphanage. As you add validations to Orphanage, be sure to
  ...
  # OrphanagesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET show" do
    it "assigns the requested orphanage as @orphanage" do
      orphanage = Orphanage.create! valid_attributes
      get :show, {:id => orphanage.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested orphanage as @orphanage" do
      orphanage = Orphanage.create! valid_attributes
      get :edit, {:id => orphanage.to_param}, valid_session
      expect(assigns(:orphanage)).to eq(orphanage)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Orphanage" do
        expect {
          post :create, {:orphanage => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved orphanage as @orphanage" do
        post :create, {:orphanage => invalid_attributes}, valid_session
        expect(assigns(:orphanage)).to be_a_new(Orphanage)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested orphanage" do
        orphanage = Orphanage.create! valid_attributes
        put :update, {:id => orphanage.to_param, :orphanage => new_attributes}, valid_session
        orphanage.reload
      ...
      it "assigns the requested orphanage as @orphanage" do
        orphanage = Orphanage.create! valid_attributes
        put :update, {:id => orphanage.to_param, :orphanage => valid_attributes}, valid_session
        expect(assigns(:orphanage)).to eq(orphanage)
      end
    ...
    describe "with invalid params" do
      it "assigns the orphanage as @orphanage" do
        orphanage = Orphanage.create! valid_attributes
        put :update, {:id => orphanage.to_param, :orphanage => invalid_attributes}, valid_session
        expect(assigns(:orphanage)).to eq(orphanage)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested orphanage" do
      orphanage = Orphanage.create! valid_attributes
      expect {
        delete :destroy, {:id => orphanage.to_param}, valid_session
      }.to change(Orphanage, :count).by(-1)
    end
